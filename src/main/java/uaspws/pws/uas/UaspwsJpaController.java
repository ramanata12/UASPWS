...
import uaspws.pws.uas.exceptions.NonexistentEntityException;
import uaspws.pws.uas.exceptions.PreexistingEntityException;
...
public class UaspwsJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("uaspws_pws.uas_jar_0.0.1-SNAPSHOTPU");
